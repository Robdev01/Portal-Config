    ...
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/80 backdrop-blur-lg">
      <div className="flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <nav className="hidden md:flex items-center gap-4">
          ...
          <Button variant="ghost" onClick={() => handleNavigate("/coordination-report")}>
            Relatórios
          </Button>
          <Button variant="ghost" onClick={() => handleNavigate("/user-list")}>
            Usuários
          </Button>
        ...
        <div className="md:hidden border-t border-border/40 bg-background shadow-sm">
          <nav className="flex flex-col p-4 space-y-2 animate-in fade-in slide-in-from-top-2 duration-200">
            ...
            <Button
              variant="ghost"
              className="justify-start"
              onClick={() => handleNavigate("/coordination-report")}
            >
              Relatórios
            </Button>
            <Button
